...
public class AppSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http
				...
				.antMatchers(HttpMethod.POST, "/devise").hasAnyRole("Admin", "Agent", "Client")        //creer devises
				.antMatchers(HttpMethod.PUT, "/devise/{code}").hasAnyRole("Admin", "Agent", "Client")    //modifier devise
				.antMatchers(HttpMethod.DELETE, "/devise/{code}").hasAnyRole("Admin", "Agent", "Client")    //supprimer devise
